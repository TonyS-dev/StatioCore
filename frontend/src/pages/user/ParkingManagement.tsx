...
const ParkingManagement = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Parking Management</h1>
        <p className="text-sm sm:text-base text-gray-600 mt-2">Check-in and check-out of parking sessions</p>
      </div>
