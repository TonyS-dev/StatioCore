...
import org.codeup.parknexus.domain.*;
 ...
 * This ensures users are created with properly hashed passwords through the service layer
 */
@Configuration
@Slf4j
...
public class DataInitializationConfig {
    ...
    public CommandLineRunner initializeTestData() {
        return args -> {
            ...
            if (userRepository.existsByEmail("admin@parknexus.com")) {
            ...
            var savedUsers = userRepository.saveAll(java.util.List.of(admin1, user1, user2, user3, inactiveUser, admin2));
            ...
            log.info("Test credentials - Email: admin@parknexus.com, Password: password123");
            ...
            ParkingSpot spot1 = parkingSpotRepository.findById(UUID.fromString("850e8400-e29b-41d4-a716-446655440001")).orElse(null);
            ParkingSpot spot3 = parkingSpotRepository.findById(UUID.fromString("850e8400-e29b-41d4-a716-446655440003")).orElse(null);
            ParkingSpot spot5 = parkingSpotRepository.findById(UUID.fromString("850e8400-e29b-41d4-a716-446655440005")).orElse(null);
            ParkingSpot spot6 = parkingSpotRepository.findById(UUID.fromString("850e8400-e29b-41d4-a716-446655440006")).orElse(null);
            ParkingSpot spot8 = parkingSpotRepository.findById(UUID.fromString("850e8400-e29b-41d4-a716-446655440008")).orElse(null);
            ParkingSpot spot9 = parkingSpotRepository.findById(UUID.fromString("850e8400-e29b-41d4-a716-446655440009")).orElse(null);
            ParkingSpot spot11 = parkingSpotRepository.findById(UUID.fromString("850e8400-e29b-41d4-a716-446655440011")).orElse(null);
            ParkingSpot spot12 = parkingSpotRepository.findById(UUID.fromString("850e8400-e29b-41d4-a716-446655440012")).orElse(null);
            ParkingSpot spot13 = parkingSpotRepository.findById(UUID.fromString("850e8400-e29b-41d4-a716-446655440013")).orElse(null);
            ParkingSpot spot14 = parkingSpotRepository.findById(UUID.fromString("850e8400-e29b-41d4-a716-446655440014")).orElse(null);
            ...
            ParkingSpot spot15 = parkingSpotRepository.findById(UUID.fromString("850e8400-e29b-41d4-a716-446655440015")).orElse(null);
            ParkingSpot spot16 = parkingSpotRepository.findById(UUID.fromString("850e8400-e29b-41d4-a716-446655440016")).orElse(null);
            ParkingSpot spot17 = parkingSpotRepository.findById(UUID.fromString("850e8400-e29b-41d4-a716-446655440017")).orElse(null);
            ParkingSpot spot18 = parkingSpotRepository.findById(UUID.fromString("850e8400-e29b-41d4-a716-446655440018")).orElse(null);
            ParkingSpot spot19 = parkingSpotRepository.findById(UUID.fromString("850e8400-e29b-41d4-a716-446655440019")).orElse(null);
            ParkingSpot spot20 = parkingSpotRepository.findById(UUID.fromString("850e8400-e29b-41d4-a716-446655440020")).orElse(null);
            ParkingSpot spot21 = parkingSpotRepository.findById(UUID.fromString("850e8400-e29b-41d4-a716-446655440021")).orElse(null);
            ParkingSpot spot22 = parkingSpotRepository.findById(UUID.fromString("850e8400-e29b-41d4-a716-446655440022")).orElse(null);
            ...
            if (spot15 != null && spot16 != null) {
                ...
                log.info("Reservations created successfully! ({} reservations saved)", savedReservations.size());
            }
